...
let larguraPalco = palco.offsetWidth //pegar a largura
let alturaPalco = palco.offsetHeight //Pega a altura
let bolas = []
let numBola = 0
...
class Bola{
    constructor(arrayBolas, palco){
        ...
        this.dirx = (Math.random() * 5) > 5 ? 1: -1
        this.diry = (Math.random() * 5) > 5 ? 1: -1
        this.palco = palco,
        this.arrayBolas = arrayBolas
        this.id = Date.now() + "_" + Math.floor() * 100000000000,
